...
!function ($) {
  ...
  * =============== */
  ...
  // Note: changed from click -> vclick to be more responsive on mobile devices.
...
!function( $ ) {
  ...
  var Datepicker = function(element, options) {
    ...
    this.component = this.element.is(':has(.add-on)') ? this.element.find('.add-on') : false;
...
!function ($) {
        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
                ...
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    ...
                    '</div>' +
                    '<div style="float: right; padding-left: 11px">' +
    ...
    DateRangePicker.prototype = {
        ...
        clickRange: function (e) {
            var label = e.target.innerHTML;
            console.log(label, this.locale.customRangeLabel, label == this.locale.customRangeLabel);
            if (label == this.locale.customRangeLabel) {
                this.container.find('.calendar').show();
            } else {
                var dates = this.ranges[label];
